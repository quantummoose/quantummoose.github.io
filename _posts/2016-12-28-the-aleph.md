...
In this single point an impossible amount of space exists. I think I have this problem of shoving an {% m %} \aleph {% em %} into my work, when a much smaller cardinality would do.
